...
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/pchmn/judgeme/blob/main/license)
[![ci](https://github.com/pchmn/judgeme/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/pchmn/judgeme/actions)
[![codecov.io](https://codecov.io/gh/pchmn/judgeme/coverage.svg?branch=main)](https://codecov.io/gh/pchmn/judgeme?branch=master)
<!-- [![Codacy Badge](https://app.codacy.com/project/badge/Grade/4c695ce061c34c1bb1698acc19278f0e)](https://www.codacy.com/gh/pchmn/judgeme/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=pchmn/judgeme&amp;utm_campaign=Badge_Grade) -->
...
[Demo](https://pchmn.github.io/judgeme/)
...
- **Deploy** to [Github Pages](https://pages.github.com/) on main branch (see deployment of this repo [here](https://pchmn.github.io/judgeme/))
...
```
npx degit pchmn/judgeme app_name
```
...
Actual [workflow](https://github.com/pchmn/judgeme/blob/main/.github/workflows/ci.yml) is:
