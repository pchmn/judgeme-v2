export const UPSERT_INSTALLATION_MUTATION = `
...
export const UPDATE_INSTALLATION_MUTATION = `
  mutation update_installations_by_pk($id: uuid!, $kuzerId: uuid!, $data: installations_set_input!) {
    update_installations_by_pk(pk_columns: { id: $id, kuzerId: $kuzerId }, _set: $data) {
      id
    }
  }
`;
